...
import flexscript.events.RenderEntityModelEvent;
...
public class OutlineUtils {
    ...
    public static void outlineEntity(ModelBase model, Entity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float headYaw, float headPitch, float scaleFactor, Color color) {
        boolean fancyGraphics = Main.mc.gameSettings.fancyGraphics;
        float gamma = Main.mc.gameSettings.gammaSetting;
        Main.mc.gameSettings.fancyGraphics = false;
        Main.mc.gameSettings.gammaSetting = Float.MAX_VALUE;
        ...
        Main.mc.gameSettings.fancyGraphics = fancyGraphics;
        Main.mc.gameSettings.gammaSetting = gamma;
    }
